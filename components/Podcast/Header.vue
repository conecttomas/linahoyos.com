...
<template>
    <header
        class="bg-primary-50 lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-md lg:items-start lg:overflow-y-auto xl:w-120">
        <div
            ...
            <span class="font-sans text-primary-500">Presentado por</span><span
                class="mt-6 flex gap-6 font-bold text-primary-900">Lina Hoyos<span aria-hidden="true"
                    class="text-primary-400">/</span>Israel Senior</span>
        </div>
        <div
            ...
            <NuxtLink to="/podcast"
                class="relative mx-auto block w-48 overflow-hidden rounded-lg bg-primary-200 shadow-xl shadow-primary-200 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl"
                aria-label="Homepage">
                <img alt="" decoding="async" data-nimg="1" class="w-full aspect-video object-cover object-center"
                    style="color:transparent" sizes="(min-width: 1024px) 20rem, (min-width: 640px) 16rem, 12rem"
                    src="/DSC04441.JPG">
            ...
            <div class="mt-10 text-center lg:mt-12 lg:text-left">
                <NuxtLink to="/podcast"><p class="text-xl font-bold text-primary-900">Liderarte</p></NuxtLink>
                <p class="mt-3 text-lg/8 font-medium text-primary-700">Donde tu ser y tu hacer ser por fin se encuentran
                </p>
            </div>
            <section class="mt-12 hidden lg:block">
                <h2 class="flex items-center font-sans text-sm/7 font-medium text-primary-900"><svg aria-hidden="true"
                        ...
                        <path d="M6 1a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V1Z"
                            class="fill-secondary-300"></path>
                    </svg><span class="ml-2.5">Resúmen</span></h2>
                <p :class="[
                    'mt-2 text-base/7 text-primary-700',
                    { 'lg:line-clamp-4': !more },
                    { 'lg:line-clamp-none': more },
                ]">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non similique consequuntur autem ea,
                    veritatis, voluptatum assumenda facere ut dolore ex minus voluptatem molestiae omnis doloremque
                    distinctio. Ab optio veniam quia ad a fuga illo iste.
                </p>
                <button type="button" @click.prevent="more = !more"
                    class="mt-2 hidden text-sm/6 font-bold text-secondary-500 hover:text-secondary-700 active:text-secondary-900 lg:inline-block">
                    {{ more ? 'Ver menos' : 'Ver más' }}
                </button>
            </section>
            <section class="mt-10 lg:mt-12">
                <h2 class="sr-only flex items-center font-sans text-sm/7 font-medium text-primary-900 lg:not-sr-only">
                    <svg aria-hidden="true" viewBox="0 0 10 10" class="h-2.5 w-2.5">
                        <path d="M0 5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V5Z"
                            class="fill-indigo-300"></path>
                        <path d="M6 1a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V1Z"
                            class="fill-blue-300"></path>
                    </svg><span class="ml-2.5">Escúchalo</span>
                </h2>
                <div class="h-px bg-linear-to-r from-primary-200/0 via-primary-200 to-primary-200/0 lg:hidden"></div>
                <ul role="list"
                    class="mt-4 flex justify-center gap-10 text-base/7 font-medium text-primary-700 sm:gap-8 lg:flex-col lg:gap-4">
                    <li class="flex"><a class="group flex items-center" aria-label="Spotify" href="/"><svg
                                aria-hidden="true" viewBox="0 0 32 32"
                                class="h-8 w-8 fill-primary-400 group-hover:fill-primary-600">
                                <path
