    ...
    <div>
            ...
            <div class="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
                <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                    <div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                        <h1 class="text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl">We’re
        ...
        <div class="overflow-hidden bg-white py-24 sm:py-32">
            <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                <div class="max-w-4xl">
                    <p class="text-base/7 font-semibold text-indigo-600">Sobre mí</p>
                    <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Lorem
                        ipsum dolor sit amet consectetur.</h1>
                    <p class="mt-6 text-balance text-xl/8 text-gray-700">Aliquet nec orci mattis amet quisque
                ...
                <section class="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
                    <div class="lg:pr-8">
                        <h2 class="text-pretty text-2xl font-semibold tracking-tight text-gray-900">Mi propósito</h2>
                        <p class="mt-6 text-base/7 text-gray-600">Faucibus commodo massa rhoncus, volutpat. Dignissim
                            sed eget risus enim. Mattis mauris semper sed amet vitae sed turpis id. Id dolor praesent
                            donec est. Odio penatibus risus viverra tellus varius sit neque erat velit. Faucibus commodo
                            massa rhoncus, volutpat. Dignissim sed eget risus enim. Mattis mauris semper sed amet vitae
                            sed turpis id.</p>
                        <p class="mt-8 text-base/7 text-gray-600">Et vitae blandit facilisi magna lacus commodo. Vitae
                            sapien duis odio id et. Id blandit molestie auctor fermentum dignissim. Lacus diam tincidunt
                            ac cursus in vel. Mauris varius vulputate et ultrices hac adipiscing egestas. Iaculis
                    ...
                    <div class="max-lg:mt-16 lg:col-span-1">
                        <p class="text-base/7 font-semibold text-gray-500">Mis logros</p>
        ...
        <div class="bg-white py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <h2 class="text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Change your
                        life with</h2>
                    <p class="mt-2 text-lg/8 text-gray-600">Learn how to grow your business with my expert advice.</p>
                </div>
                <div
                    ...
                    <article class="flex flex-col items-start">
                        <div class="relative w-full">
                            <img src="https://images.unsplash.com/photo-1496128858413-b36217c2ce36?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3603&q=80"
                                alt=""
                                class="aspect-video w-full rounded-2xl bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/3]">
                    ...
                    <article class="flex flex-col items-start mt-32">
                        <div class="relative w-full">
                            <img src="https://images.unsplash.com/photo-1496128858413-b36217c2ce36?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=3603&q=80"
                                alt=""
                                class="aspect-video w-full rounded-2xl bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/3]">
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
                    <div class="mx-auto w-full max-w-xl lg:mx-0">
                        <h2 class="text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl">Trusted by
                            the most innovative teams</h2>
                        <p class="mt-6 text-lg/8 text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Et, egestas tempus tellus etiam sed. Quam a scelerisque amet ullamcorper eu enim et
                            fermentum, augue.</p>
                        <div class="mt-8 flex items-center gap-x-6">
                            <a href="#" class="btn btn-solid">Create
                                account</a>
                            <a href="#" class="text-sm font-semibold text-white">Contact us <span
                    ...
                    <div
                        ...
                        <img class="max-h-12 w-full object-contain object-left"
                            src="https://tailwindcss.com/plus-assets/img/logos/tuple-logo-white.svg" alt="Tuple"
                            width="105" height="48">
                        <img class="max-h-12 w-full object-contain object-left"
                            src="https://tailwindcss.com/plus-assets/img/logos/reform-logo-white.svg" alt="Reform"
                            width="104" height="48">
                        <img class="max-h-12 w-full object-contain object-left"
                            src="https://tailwindcss.com/plus-assets/img/logos/savvycal-logo-white.svg" alt="SavvyCal"
                            width="140" height="48">
                        <img class="max-h-12 w-full object-contain object-left"
                            src="https://tailwindcss.com/plus-assets/img/logos/laravel-logo-white.svg" alt="Laravel"
                            width="136" height="48">
                        <img class="max-h-12 w-full object-contain object-left"
                            src="https://tailwindcss.com/plus-assets/img/logos/transistor-logo-white.svg"
                            alt="Transistor" width="158" height="48">
                        <img class="max-h-12 w-full object-contain object-left"
                            src="https://tailwindcss.com/plus-assets/img/logos/statamic-logo-white.svg" alt="Statamic"
                            width="147" height="48">
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div
                    ...
                    <div class="lg:pr-4">
                        <div
                            class="relative overflow-hidden rounded-3xl bg-secondary px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                    ...
                    <div>
                        <div class="text-base/7 text-gray-700 lg:max-w-lg">
                            <p class="text-base/7 font-semibold text-primary">Launch your Challange</p>
                            <h1
                                class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-secondary sm:text-5xl">
                                What Do You Want?</h1>
                            <div class="max-w-xl">
                                <p class="mt-6">Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus enim.
                        ...
                        <div class="mt-10 flex">
                            <a href="#" class="text-base/7 font-semibold text-primary">Let’s Start Together!
        ...
        <div class="bg-muted py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <h2 class="text-balance text-4xl font-semibold tracking-tight text-secondary sm:text-5xl">My courses
                    </h2>
                    <p class="mt-2 text-lg/8 text-gray-600">Learn how to grow your business with my expert advice.</p>
                </div>
                <div
                    ...
                    <article
                        class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-secondary px-8 pb-8 pt-80 sm:pt-48 lg:pt-80">
                        <img src="https://coaching.thimpress.com/life-coaching/wp-content/uploads/sites/50/2022/09/course-new-3.jpg"
                            alt="" class="absolute inset-0 -z-10 size-full object-cover">
                        <div class="absolute inset-0 -z-10 bg-gradient-to-t from-secondary via-secondary/40"></div>
                        <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-secondary/10"></div>
                    ...
                    <article
                        class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-secondary px-8 pb-8 pt-80 sm:pt-48 lg:pt-80">
                        <img src="https://coaching.thimpress.com/life-coaching/wp-content/uploads/sites/50/2022/06/course-new-05.jpg"
                            alt="" class="absolute inset-0 -z-10 size-full object-cover">
                        <div class="absolute inset-0 -z-10 bg-gradient-to-t from-secondary via-secondary/40"></div>
                        <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-secondary/10"></div>
                    ...
                    <article
                        class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-secondary px-8 pb-8 pt-80 sm:pt-48 lg:pt-80">
                        <img src="https://coaching.thimpress.com/life-coaching/wp-content/uploads/sites/50/2022/09/course-new-1.jpg"
                            alt="" class="absolute inset-0 -z-10 size-full object-cover">
                        <div class="absolute inset-0 -z-10 bg-gradient-to-t from-secondary via-secondary/40"></div>
                        <div class="absolute inset-0 -z-10 rounded-2xl ring-1 ring-inset ring-secondary/10"></div>
                ...
                <div class="flex items-center justify-center mt-16">
                    <button class="btn btn-lg btn-primary">View all</button>
                </div>
            </div>
        </div>
        ...
        <div class="relative isolate bg-white pb-32 pt-24 sm:pt-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    ...
                    <p class="mt-2 text-balance text-4xl font-semibold tracking-tight text-secondary sm:text-5xl">What
                        do you want?</p>
                </div>
                <div
                    ...
                    <figure
                        class="rounded-2xl bg-white shadow-lg ring-1 ring-secondary/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
                        <blockquote
                    ...
                    <div class="space-y-8 xl:contents xl:space-y-0">
                        <div class="space-y-8 xl:row-span-2">
                            <figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-secondary/5">
        ...
        <div class="bg-white py-16 sm:py-24">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div
                    class="relative isolate flex flex-col gap-10 overflow-hidden bg-secondary px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:flex-row xl:items-center xl:py-32">
                    <h2
                        class="max-w-xl text-balance text-3xl font-semibold tracking-tight text-white sm:text-4xl xl:flex-auto">
                        Want our product updates? Sign up for our newsletter.</h2>
                    <form class="w-full max-w-md">
                        <div class="flex gap-x-4">
                            ...
                            <button type="submit"
                                class="flex-none rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-secondary shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Notify
                                me</button>
                        </div>
                        <p class="mt-4 text-sm/6 text-white">We care about your data. Read our <a href="#"
                ...
                <div
                    ...
                    <div class="">
                        <div class="text-base/7 text-gray-700 lg:max-w-lg">
                            ...
                            <h1
                                class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-secondary sm:text-5xl">
                                My Bestseller Book</h1>
                            <div class="max-w-xl">
                                <p class="mt-6">Unlock the Key to True Happiness with this Life-Changing Guidebook.
                                    Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing
                                    industries for previewing layouts and visual mockups.</p>
                            </div>
                        </div>
                        <div class="mt-10 flex">
                            <a href="#" class="btn btn-solid btn-primary">Get it now!</a>
                        </div>
                    </div>

                    <div class="lg:pl-4">
                        <div
                            class="relative overflow-hidden rounded-3xl bg-secondary px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10 h-[45vh]">
                            <img class="absolute inset-0 size-full object-cover"
                                src="https://m.media-amazon.com/images/I/81ANaVZk5LL._AC_UF1000,1000_QL80_.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
