<template>
    <footer class="bg-primary mx-auto relative">
        <div class="mx-auto max-w-7xl px-6 py-8 lg:px-8 ">
            ...
            <div
                class="mt-16 border-t border-secondary pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
                <div class="flex gap-x-6 md:order-2">
                    <a href="#" class="text-secondary hover:text-accent-3">
